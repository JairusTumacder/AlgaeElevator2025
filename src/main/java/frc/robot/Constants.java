...
public final class Constants {
  ...
  public static class ElevatorConstants{
    ...
    static {
        elevConfigs.CurrentLimits.StatorCurrentLimit = 0.0;
        elevConfigs.MotorOutput.Inverted = InvertedValue.CounterClockwise_Positive;
        elevConfigs.MotorOutput.NeutralMode = NeutralModeValue.Brake;
        elevConfigs.Slot0.GravityType = GravityTypeValue.Elevator_Static;
        elevConfigs.Slot0.kS = 0.0;  
        elevConfigs.Slot0.kG = 0.0;
        elevConfigs.Slot0.kV = 0.0;  
        elevConfigs.Slot0.kA = 0.0;  
        elevConfigs.Slot0.kP = 0.0;  
        elevConfigs.Slot0.kI = 0.0;  
        elevConfigs.Slot0.kD = 0.0;  
        elevMMConfigs.MotionMagicCruiseVelocity = 0;    
        elevMMConfigs.MotionMagicAcceleration = 0; ;
    }
  }
}
