...
public class AlgeaShooter extends SubsystemBase {
  ...
  public void checkMotorStall() {
    if (algeaMotor.getStatorCurrent().getValueAsDouble() > 20 && algeaMotor.get() < -0.08) { // check the direction ) //
                                                                                             // replace with
                                                                                             // .getOutPutCurrent for
                                                                                             // sparks
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("current", algeaMotor.getStatorCurrent().getValueAsDouble()); // replace with
                                                                                           // .getOutPutCurrent for
                                                                                           // sparks
  }
}